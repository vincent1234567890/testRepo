...
(function(root, factory) {
    ...
    function getIOSocketFromClient (client) {
        ...
        const ourMessageHandler = (msg) => {
            ...
            console.warn("socketUtils.getIOSocketFromClient received a non-JSON packet:", data);
        };
        ...
        var socket = {
            ...
            // Handles messages which do not have a specific type
            handle: function (packet) {
                console.warn("socketUtils.getIOSocketFromClient received a packet with no type:", packet);
                console.warn("You should override emitter.handle() in order to process this.");
            },
        };
