...
(function(root, factory) {
    ...
    const clientInformer = function (ioSocket) {
        ...
        return {
            ...
            fishAppeared: function (fishId, location, fishType, when, motionPatternGroup, motionPatternId) {
                ioSocket.emit('f', {f: fishId, l: location, t: fishType, w: when, mg: motionPatternGroup, mi: motionPatternId});
            },
