...
(function(root, factory) {
    ...
    const clientInformer = function (ioSocket) {
        ...
        return {
            ...
            fishAppeared: function (fishType, fishId, position, angle, when, motionPatternGroup, motionPatternId, fishHealth) {
                ioSocket.emit('f', {t: fishType, f: fishId, l: trimVector(position), a: trimFloat(angle), w: when, mg: motionPatternGroup, mi: motionPatternId, h: fishHealth});
            },
