...
(function(root, factory) {
    ...
    const clientInformer = function (ioSocket) {
        ...
        return {
            ...
            fishesWereCaught: function (playerId, fishCaughtEvents, scoreMultiplier, totalScoreChange) {
                // fishCaughtEvents should be of the form: [{f: fishId, s: scoreChange}, ...]
                ioSocket.emit('k', {p: playerId, e: fishCaughtEvents, m: scoreMultiplier, s: totalScoreChange});
            },
