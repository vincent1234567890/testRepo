...
(function(root, factory) {
    ...
    const clientInformer = function (ioSocket) {
        ...
        return {
            ...
            fishAppeared: function (fishType, fishId, offsetFromGroup, angle, when, motionPatternGroup, motionPatternId, fishHealth) {
                ioSocket.emit('f', {t: fishType, f: fishId, o: trimVector(offsetFromGroup), a: trimFloat(angle), w: when, mg: motionPatternGroup, mi: motionPatternId, h: fishHealth});
            },
