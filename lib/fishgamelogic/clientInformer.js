...
(function(root, factory) {
    ...
    const clientInformer = function (ioSocket) {
        ...
        return {
            ...
            playerFiredBullet: function (playerId, bulletId, bulletLevel, bulletCost, angle, when) {
                ioSocket.emit('b', {p: playerId, b: bulletId, l: bulletLevel, c: bulletCost, a: trimFloat(angle), w: when});
            },
            ...
            bulletWithdrawn: function (bulletId) {
                ioSocket.emit('wb', {b: bulletId});
            },
            ...
            roundIsChanging: function (roundNumber, roundName) {
                ioSocket.emit('rc', {i: roundNumber, n: roundName});
            },

            targetLockOff: function () {
                ioSocket.emit('tlo', {});
            },
