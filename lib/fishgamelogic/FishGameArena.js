...
(function(root, factory) {
    ...
    function FishGameArena (onServer, gameConfig, fishGame, _gameStartTime) {
        ...
        function spawnFish (fishType, fishId, offsetFromGroup, angle, fishSpawnTime, motionPatternGroup, motionPatternId, fishHealth) {
            const fishClass = getFishClass(fishType);

            return addFish(fishType, fishId, offsetFromGroup, angle, motionPatternGroup, motionPatternId, 0, fishSpawnTime, fishHealth, fishSpawnTime);
        }

        function addFish (fishType, fishId, offsetFromGroup, angle, motionPatternGroup, motionPatternId, motionPatternBit, bitStartTime, fishHealth, lastUpdateTime) {
            const fish = {
                type: fishType,
                id: fishId,
                position: [-1000, -1000],
