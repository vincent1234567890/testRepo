...
(function(root, factory) {
    ...
    function FishGameArena (onServer, gameConfig, fishGame) {
        ...
        function spawnPlayer (playerId, playerName, playerSlot) {
            addPlayer(playerId, playerName, playerSlot, 0, 0);
        }

        function addPlayer (playerId, playerName, playerSlot, gunAngle, gunId) {
        ...
        function spawnFish (fishType, fishId, position, angle, fishSpawnTime, motionPatternGroup, motionPatternId) {
            ...
            addFish(fishType, fishId, position, angle, motionPatternGroup, motionPatternId, 0, fishSpawnTime, fishClass.health);
        }
        ...
        function spawnBullet (owner, bulletId, gunId, angle, startTime) {
            ...
            addBullet(owner.playerId, bulletId, gunId, owner.arenaPlayer.cannonPosition, velocity);
        }
