...
(function(root, factory) {
    ...
    function FishGameArena (onServer, gameConfig, fishGame, _gameStartTime) {
        ...
        function spawnFish (fishType, fishId, position, angle, fishSpawnTime, motionPatternGroup, motionPatternId) {
            ...
            return addFish(fishType, fishId, position, angle, motionPatternGroup, motionPatternId, 0, fishSpawnTime, fishClass.health, fishSpawnTime);
        }
        ...
        function spawnBullet (ownerId, bulletId, gunId, angle, startTime) {
            ...
            return addBullet(ownerId, bulletId, gunId, position, velocity, startTime);
        }

        function addBullet (ownerId, bulletId, gunId, position, velocity, lastUpdateTime) {
            if (bullets[bulletId]) {
