...
(function(root, factory) {
    ...
    function FishGameArena (onServer, gameConfig, fishGame) {
        ...
        // In the end we will probably call doUpdate() from the client's main frame loop
        // But for now we run our own independent timer on the client, started here.
        //if (onServer) {
