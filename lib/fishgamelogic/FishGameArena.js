    ...
    function FishGameArena (onServer, gameConfig, fishingRoom, _gameStartTime, _consumptionInThisGame) {
        ...
        function moveFish (fish, deltaTime) {
            ...
            if (fishAreScattering) {
                ...
                const timeSinceRoundChange = currentTime - gameTimeWhenRoundStarted;
                ...
                const relativeSpeedToApply = relativeSpeed + (targetRelativeSpeed - relativeSpeed) * timeSinceRoundChange / 10000;

                tPath = (relativeSpeed * timeBetweenSpawnAndRoundChange + relativeSpeedToApply * timeSinceRoundChange) / motionPattern.duration / 1000;
            }
