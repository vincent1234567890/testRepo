                ...
                if (distanceSquared < maxDist * maxDist) {
                    ...
                    if (damageDealt > 0) {
                        ...
                        if (fish.health <= 0) {
                            ...
                            const player = getPlayer(bullet.ownerId);
                            ...
                            if (player) {
                                ...
                                changePlayerScore(bullet.ownerId, scoreChange);
                            }

                            // @todo Need to change this.  The actual score change might be increased by a multicatch.
