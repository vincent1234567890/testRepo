    ...
    const clientReceiver = function (ioSocket, gameCtrl) {
        ...
        ioSocket.on('gs', gameState => {
            ...
            for (let fishId in fishes) {
                ...
                arena.addFish(fish.type, fish.id, fish.position, fish.angle, fish.motionPatternGroup, fish.motionPatternId, fish.motionPatternBit, fish.bitStartTime, fish.health, serverGameTime);
                createFishActor(fish.type, fish.id, fish.position);
            }
            for (let bulletId in bullets) {
                const bullet = bullets[bulletId];
                arena.addBullet(bullet.ownerId, bullet.id, bullet.gunId, bullet.position, bullet.velocity, serverGameTime);
