...
(function(root, factory) {
    ...
    const clientReceiver = function (ioSocket, gameCtrl) {
        ...
        ioSocket.on('f', data => {
            ...
            const ccPosition = cc.p(position[0], position[1]);
            // @todo We need to tell the fish what his fishType and his fishId is.
            gameMainSessionController.addFishAtPosition(ccPosition);
        });
