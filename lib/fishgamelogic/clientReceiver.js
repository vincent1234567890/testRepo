...
(function (root, factory) {
    ...
    const clientReceiver = function (ioSocket) {
        ...
        ioSocket.on('psjg', data => {
            ...
            const jpNotification = new cc.Sprite(ReferenceName.JackpotNotificationBackground);
            ...
            const moveToCenter = cc.moveTo(2, cc.p(cc.winSize.width * 0.5, cc.winSize.height * 0.5)).easing(cc.easeOut(3));
            const scaleTo1 = cc.scaleTo(1, 1).easing(cc.easeOut(3));
