...
(function(root, factory) {
    ...
    const clientReceiver = function (ioSocket, gameCtrl) {
        ...
        ioSocket.on('gs', gameState => {
            ...
            gameCtrl.startGameScene();

            for (let player of players) {
                arena.spawnPlayer(player.playerId, player.playerName, player.playerSlot, player.score);
                createPlayerActor(player.playerId, player.playerName, player.playerSlot);
        ...
        ioSocket.on('j', data => {
            ...
            GameManager.updateMultiplayerState({playerId : playerId, playerName : playerName, playerSlot : playerSlot, score : playerScore});
        });
        ...
        ioSocket.on('f', data => {
            ...
            //console.log(`[delta ${when - arena.getGameTime()}] new fish at ${when} and current time is ${arena.getGameTime()}`);
