    ...
    const clientReceiver = function (ioSocket) {
        ...
        ioSocket.on('youWonJackpot', data => {
            ...
            ClientServerConnect.listUncollectedJackpots().then(response => {
                ...
                GameView.addView(jackpotPanel);

                ClientServerConnect.getServerInformer().shareJackpotGameStarted(jackpotRewardLog.jackpotId);
            }).catch(console.error);

            // @todo When the minigame finishes, JackpotPanel should call 'collectJackpot' to collect the winnings:
            //
        ...
        ioSocket.on('psjg', data => {
            ...
            GameView.addView(watchingJackpotPanel);
        });
        ...
        ioSocket.on('pojb', data => {
            ...
            watchingJackpotPanel.showBoxOpening(boxNumber);
        });
