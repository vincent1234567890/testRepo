...
(function (root, factory) {
    ...
    const clientReceiver = function (ioSocket) {
        ...
        ioSocket.on('psjg', data => {
            ...
            let matr = GameManager.getGameConfig().cannonPositions[seatNo];
            ...
            let jpLight = new cc.Sprite(ReferenceName.JackpotCannonLight);
            let jpNotification = new cc.Sprite(ReferenceName.JackpotNotificationBackground);
            ...
            let moveToCenter = cc.moveTo(2, cc.p(cc.winSize.width * 0.5, cc.winSize.height * 0.5)).easing(cc.easeOut(3));
            let scaleTo1 = cc.scaleTo(1, 1).easing(cc.easeOut(3));
            let spawnNoti = cc.spawn(scaleTo1, moveToCenter);
