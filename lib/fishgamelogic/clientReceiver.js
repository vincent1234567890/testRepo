...
(function(root, factory) {
    ...
    const clientReceiver = function (ioSocket, gameCtrl) {
        ...
        ioSocket.on('gs', gameState => {
            ...
            const arena = createArenaFromState(gameConfig, gameState, gameStartTime, serverGameTime);
        ...
        ioSocket.on('g', data => {
            ...
            const showGunChange = !isCurrentPlayer(playerId);
            if (showGunChange) {
        ...
        ioSocket.on('b', data => {
            ...
            if (arena.hasPlayer(ownerId)) {
                ...
                const showCannonAnimation = !isCurrentPlayer(ownerId);
        ...
        ioSocket.on('f', data => {
            ...
            arena.spawnFish(fishType, fishId, position, angle, when, motionPatternGroup, motionPatternId, fishHealth);
        ...
        function createFishActor (fishType, fishId, position) {
            ...
            if (FishAnimationData[fishType]){
                ...
                console.log("this shouldn't happen: " , fishType)
        ...
        function isCurrentPlayer (playerId) {
            return playerId === GameCtrl.sharedGame().getMyPlayerId();
        }
    ...
    function createArenaFromState (gameConfig, gameState, gameStartTime, serverGameTime) {
        ...
        const arena = new FishGameArena(false, gameConfig, null, gameStartTime);
