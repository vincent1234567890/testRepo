    ...
    const serverReceiver = function (roomPlayer, ioSocket, fishingRoom, arena) {
        ...
        ioSocket.on('b', data => {
            ...
            if (timeSinceLastShot < 0.98 * gameConfig.shootInterval) {
                ...
                roomPlayer.informClient.error("You are trying to fire too quickly.  Requested shot will not be fired.");
                return;
            }
            ...
            dbPlayLog.logBulletFired(roomPlayer.playerData._id, arenaPlayer.gunId, -bulletCost);
