...
(function (root, factory) {
    ...
    const serverReceiver = function (roomPlayer, ioSocket, fishingRoom, serverArena) {
        ...
        ioSocket.on('requestStartJackpotGame', data => {
            ...
            dbModel.jackpotRewardLog.findOne({
                ...
                jackpotRewardLog => {
                    ...
                    serverArena.pauseGame();

                    // Let the player know his jackpot minigame can start
                    roomPlayer.informClient.playerStartedJackpotGame(roomPlayer.id, jackpotRewardLog);
        ...
        ioSocket.on('jackpotGameOver', data => {
            serverArena.unpauseGame();
            fishingRoom.informAllClients.jackpotGameEnded();
        });
