...
(function(root, factory) {
    ...
    const serverReceiver = function (roomPlayer, ioSocket, fishingRoom, arena) {
        ...
        ioSocket.on('b', data => {
            ...
            const expChange = +1;
            arena.changePlayerScoreAndXPOnServer(arenaPlayer.id, -bulletCost, expChange, roomPlayer);
            dbPlayLog.logBulletFired(roomPlayer.playerData, arenaPlayer.gunId, scoreChange, expChange);
