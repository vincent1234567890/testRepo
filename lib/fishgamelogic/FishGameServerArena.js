...
const playerGameStats = require("../../../Server/playerGameStats.js");
        ...
        if (numberOfFishCaught > 0) {
            ...
            if (self.hasPlayer(bullet.ownerId)) {
                ...
                if (numberOfFishCaught > 1) {
                    playerGameStats.recordMultiCatch(gamePlayer, numberOfFishCaught, scoreMultiplier, totalScoreChange);
                }
                for (let fishLogEvent of fishLogEvents) {
                    playerGameStats.recordFishCaught(gamePlayer, fishLogEvent.type, fishLogEvent.value * gunMultiplier * scoreMultiplier, bullet.gunId);
                }
            }
