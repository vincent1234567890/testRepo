...
var UnLockStageLayer = cc.Layer.extend({
    ...
    initWithDelegate:function (de, le) {
        ...
        var titleSprite = cc.Sprite.createWithSpriteFrameName(ImageNameLang("fonts_other_010.png", true));
        ...
        if (le < 3) {
            ...
            var coinMenuItem = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_020.png", true));
            var coinMenuItemd = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_021.png", true));
            var coinItem = cc.MenuItemSprite.create(coinMenuItem, coinMenuItemd, this, this.useCoin);

            if (SUPPORT_UNLOCK_BY_MONEY) {
                var moneyMenuItem = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_023.png", true));
                var moneyMenuItemd = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_022.png", true));
                var moneyItem = cc.MenuItemSprite.create(moneyMenuItem, moneyMenuItemd, this, this.useMoney);
            }
            var cancelMenuItem = cc.Sprite.createWithSpriteFrameName(("button_other_025.png"));
            var cancelMenuItemd = cc.Sprite.createWithSpriteFrameName(("button_other_024.png"));
...
//            var judgeLevelMenuItem  = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_020.png",true));
//            var judgeLevelMenuItemd = cc.Sprite.createWithSpriteFrameName(ImageNameLang("button_other_021.png",true));
...
//            menu = cc.Menu.create(judgeLevelItem,cancelItem1);
            var cancelMenuItem1 = cc.Sprite.createWithSpriteFrameName(("button_other_025.png"));
            var cancelMenuItemd1 = cc.Sprite.createWithSpriteFrameName(("button_other_024.png"));
            ...
            this._menu = cc.Menu.create(cancelItem1);
                ...
                var shijichengjiu = cc.Sprite.createWithSpriteFrameName(("10jichengjiu.png"));
        ...
        /*if (le == 3) {
            ...
            var pDescLabel = cc.LabelTTF.create(strDescription, "Arial", 13*//*cc.Size (160, 30), cc.TextAlignmentLeft*//*);
