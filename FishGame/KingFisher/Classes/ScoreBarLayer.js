...
var ScoreBarLayer = cc.Layer.extend({
    ...
    init:function () {
        if (this._super()) {
            ...
            var tipOffset = cc.pAdd(cc.p(0, this._moneyTip.getContentSize().height / 2), cc.p(-266 -38, -18 +10));
            ...
            weaponBase.setPosition(cc.p(0 -12, weaponBase.getContentSize().height / 2));
            // weaponBase.setScale(1.05);
            ...
            //Eugene:changed this to contrast changed ui (dark bkg)
            // // 生成按钮菜单
            ...
            var numScroll = NumberScrollLabel.create();
            numScroll.initWithSize(ImageName("ui_number_time.png"), cc.SizeMake(25, 28), 18, 26);
            numScroll.setComponentNumber(6);
            this.setBulletsLabel(numScroll);

            this.addChild(this._bulletsLabel, 60);
            this._bulletsLabel.setPosition(cc.p(-345, 15));
            ...
            this._downTimeLabel.setPosition(cc.p(-150, 18));
    ...
    _initLightBlood:function (lbPos, lbScale) {
        ...
        this._lightBlood.setPosition(cc.p(2, -2));
