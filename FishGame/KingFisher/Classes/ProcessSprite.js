...
var ProcessSprite = cc.Sprite.extend({
    ...
    initWithDef:function (def) {
        ...
        this.originalPosition = cc.p(0/* + def.getOffset().width*/ - 50, sprite.getContentSize().height / 2/* + def.getOffset().height*/ - 14);
        ...
        spriteBg.setPosition(cc.p(spriteBg.getContentSize().width / 2 - 50, spriteBg.getContentSize().height / 2 - 14));
