...
var WeaponCannon = Weapon.extend({
    ...
    initWeapon:function (weaponLevel, pos) {
        ...
        menuRight.setScale(0.5);

        menuLeft.setPosition(cc.pAdd(cc.p(this.getContentSize().width / 2, menuLeft.getContentSize().height / 2), cc.p(-60, -20)));
        menuRight.setPosition(cc.pAdd(cc.p(this.getContentSize().width / 2, menuRight.getContentSize().height / 2), cc.p(60, -20)));
