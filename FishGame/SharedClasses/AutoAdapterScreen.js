var AutoAdapterScreen = cc.Class.extend({
    ...
    adjustSize:function () {
        this.getWinSize();
        this.setVisibleRect();
        cc.canvas.width = this._width;
        cc.canvas.height = this._height;
    ...
    setVisibleRect:function () {
        // 获取Screen在View中的坐标
        s_rcVisible = cc.RectMake(0, 0, this._width, this._height);
        ...
        EScreenRect = cc.RectMake(1.0, 1.0, this._width + 10, this._height + 10);
        LEVINBULLETALIVERECT = cc.RectMake(-10.0, -10.0, this._width + 20, this._height + 20);
    }
});
